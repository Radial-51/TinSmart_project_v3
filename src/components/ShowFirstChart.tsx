...
import useApiTodayHook from '../hooks/useApiTodayHook';
...
const ShowFirstChart = () => {
  ...
  const [containersData, loading, error] = useApiTodayHook();
  ...
  return (
    <View style={styles.container}>
      <View style={styles.card}>
        <Text style={styles.cardTitle}>Información de Hoy</Text>
      ...
      <View style={styles.card}>
        <Text style={styles.cardTitle}>Gráfica de Hoy</Text>
        <View style={styles.cardContent}>
